...
def showTestWindow():
    ...
    mainWindow.addWidget(4, Text("版本:"+__version__(), type=1))
    mainWindow.addWidget(6, Text("作者:Lettle", type=1))
    mainWindow.addWidget(8, Text("w向上s向下y确认", type=1))
    mainWindow.addWidget(9, Text("一起学习?加作者QQ:1071445082", type=1))
    mainWindow.addWidget(10, Text("---By Lettle", type=2))
